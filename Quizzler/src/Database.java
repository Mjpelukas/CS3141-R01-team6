...
public class Database {
	 ...
	 */
	public ArrayList<String[]> viewQuizQuestions(int quizID) {
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		...
		try {
			...
			String query = "SELECT questionID, prompt, answer, choiceA, choiceB, choiceC, choiceD FROM QuizQuestions WHERE quizID = ?";
			...
			while (resultSet.next()) {
				String questionID = String.valueOf(resultSet.getInt(1));
				String questionPrompt = resultSet.getString(2);
				String answer = resultSet.getString(3);
				String choiceA = resultSet.getString(4);
				String choiceB = resultSet.getString(5);
				String choiceC = resultSet.getString(6);
				String choiceD = resultSet.getString(7);
				//char answer = resultSet.get
				
				String[] question = {questionID, questionPrompt, answer, choiceA, choiceB, choiceC, choiceD};
